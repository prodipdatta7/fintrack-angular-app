...
export class SettingsComponent implements OnInit {
  ...
  uploadAvatar(file: File): void {
    ...
    this.userService.uploadAvatar(file).pipe(takeUntilDestroyed(this.destroyRef))
      .subscribe({
        next: (res) => {
        ...
        error: (err) => {
          this.avatarPreview = null;
          this.snackBar.open(err.error?.error || 'Failed to upload avatar', 'Close', { duration: 4000 });
          this.isUploadingAvatar = false;
        }
      });
  }
  ...
  saveProfile(): void {
    ...
    this.userService.updateProfile({
      ...
      .subscribe({
        ...
        error: (err) => {
          this.snackBar.open(err.error?.error || 'Failed to update profile', 'Close', { duration: 4000 });
          this.isSavingProfile = false;
        }
      });
  }
  ...
  changePassword(): void {
    ...
    this.userService.changePassword({
      ...
      .subscribe({
        ...
        error: (err) => {
          this.snackBar.open(err.error?.error || 'Failed to change password', 'Close', { duration: 4000 });
          this.isSavingPassword = false;
        }
      });
  }
  ...
  savePreferences(): void {
    ...
    this.userService.updateSettings({
      ...
      .subscribe({
        ...
        error: (err) => {
          this.snackBar.open(err.error?.error || 'Failed to save preferences', 'Close', { duration: 4000 });
          this.isSavingSettings = false;
        }
      });
  }
  ...
  exportData(): void {
    this.userService.exportData().pipe(takeUntilDestroyed(this.destroyRef))
      .subscribe({
        next: (blob) => {
        ...
        error: (err) => {
          this.snackBar.open(err.error?.error || 'Failed to export data', 'Close', { duration: 4000 });
        }
      });
  }
  ...
  deleteAccount(): void {
    ...
    this.userService.deleteAccount(this.deletePassword).pipe(takeUntilDestroyed(this.destroyRef))
      .subscribe({
        next: () => {
        ...
        error: (err) => {
          this.snackBar.open(err.error?.error || 'Failed to delete account', 'Close', { duration: 4000 });
  ...
  logoutAllSessions(): void {
    this.userService.logoutAll().pipe(takeUntilDestroyed(this.destroyRef))
      .subscribe({
        next: () => {
        ...
        error: (err) => {
          this.snackBar.open(err.error?.error || 'Failed to logout sessions', 'Close', { duration: 4000 });
        }
      });
  }
  ...
  private loadSettings(): void {
    this.userService.getSettings().pipe(takeUntilDestroyed(this.destroyRef))
      .subscribe({
        next: (settings) => {
